...
class _FeedPageState extends State<FeedPage> {
  ...
  Future<void> fetchUsers() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Error retrieving users: ${response.statusCode}');
      }
    } catch (e) {
      print('Exception: $e');
    }
  ...
  Future<dynamic> getUserById(int userId) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('Error retrieving user with ID: $userId');
      return null;
    }
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            if (user != null) ...[
                              GestureDetector(
                                onTap: () {
                                  // Navigate to user profile page or perform desired action
                                  print('User name tapped: ${user['name']}');
