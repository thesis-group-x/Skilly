...
class _WebPageState extends State<WebPage> {
  ...
  List<Post> trendingWebPosts = [];
  List<Post> favouriteWebPosts = [];
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Stack(
              children: <Widget>[
                CardScrollWidget(currentPage, trendingWebPosts),
                Positioned.fill(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: favouriteWebPosts.length,
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () => navigateToPost(favouriteWebPosts[index]),
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(favouriteWebPosts[index].image),
                          ),
                        ),
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              Positioned(
                                ...
                                child: CircleAvatar(
                                  ...
                                  backgroundImage: NetworkImage(
                                    favouriteWebPosts[index].user.profileImage,
                                  ),
                                ),
                              ),
                              Positioned(
                                ...
                                left: 60,
                                child: Text(
                                  favouriteWebPosts[index].user.name,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 16,
                                  ),
