...
class DesPage extends StatefulWidget {
  @override
  _DesPageState createState() => new _DesPageState();
}
...
class _DesPageState extends State<DesPage> {
  ...
  List<Post> trendingDesPosts = [];
  List<Post> favouriteDesPosts = [];
  ...
  Future<void> fetchRandomDesPosts() async {
    try {
      final List<Post> allPosts = await PostService.getPostsBySkill("Design");
      final random = Random();
  ...
  Future<void> fetchDesPosts() async {
    try {
      final List<Post> posts = await PostService.getPostsBySkill("Design");
      setState(() {
        favouriteDesPosts = posts;
      });
    } catch (error) {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            Stack(
              children: <Widget>[
                CardScrollWidget(currentPage, trendingDesPosts),
                Positioned.fill(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: favouriteDesPosts.length,
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      onTap: () => navigateToPost(favouriteDesPosts[index]),
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: NetworkImage(favouriteDesPosts[index].image),
                          ),
                        ),
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              Positioned(
                                ...
                                child: CircleAvatar(
                                  ...
                                  backgroundImage: NetworkImage(
                                    favouriteDesPosts[index].user.profileImage,
                                  ),
                                ),
                              ),
                              Positioned(
                                ...
                                left: 60,
                                child: Text(
                                  favouriteDesPosts[index].user.name,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 16,
                                  ),
